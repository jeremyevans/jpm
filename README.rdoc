...
= Usage
  ...
  # Same as find, but if there is a single result, displays
  # entry, asking for password to decrypt
  jpm s f.o
...
* Added features
  ...
  * +s+ command to find entries and also show entry if there is a single result
  * This README
* Changed features
